#!/bin/bash
#
# Created by: Fox111010
#
# T-BONE
#
# VARIABLES
#
source $HOME/T-BONE/Colors.sh#
#
# FUNCIONES
#
function T-BONE {
...
echo -e "${verde}
    ...
    ____________________| i n s t a l l |_________________
   |                    .---------------.                 |
   |  1.> unzip/unrar                                     |
   |  B.> run the wpdate                                  |
   |  C.> copy ever crack                                 |
   |  4.> play                                            |
   |                                                      |
   |         ____  ___________  _____  ______________     |
   |_____   / __ \/ ____// __ \/ ___/ / ____/_/ ____/\____|
     |     / / / / _ / // / / /\__  \/ ____/\/ /\   \/  |
     |    / /_/ / /___// /_/ /___/  / /___/ / /_/---    |
    _|__ /_____/_____//_____//_____/______/\_____/\    _|_
   |     \____\_\____\\\____\_\____\\_____\_\____\/       |
   |                                                      |
   |                                                      |
   |                                                      |
   |                                                      |
   |______________________________________________________|${blanco}
}
#
# CÓDIGO
#
